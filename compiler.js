...
return ((function() {var o9 = (function(_var_,value_dash_code){
...
var o10 = assignment_dash_variable(exp);
var o11 = compile(assignment_dash_value(exp),string_dash__gt_symbol("val"),string_dash__gt_symbol("next"));
return o9(o10,o11);
}))();
});
var compile_dash_definition = (function(exp,target,linkage){
return ((function() {var o12 = (function(_var_,value_dash_code){
...
var o13 = definition_dash_variable(exp);
var o14 = compile(definition_dash_value(exp),string_dash__gt_symbol("val"),string_dash__gt_symbol("next"));
return o12(o13,o14);
}))();
});
var compile_dash_if = (function(exp,target,linkage){
return ((function() {var o15 = (function(t_dash_branch,f_dash_branch,after_dash_if,consequent_dash_linkage,p_dash_code,c_dash_code,a_dash_code){
...
var o16 = make_dash_label(string_dash__gt_symbol("true_dash_branch"));
var o17 = make_dash_label(string_dash__gt_symbol("false_dash_branch"));
var o18 = make_dash_label(string_dash__gt_symbol("after_dash_if"));
var o19 = (function() {if(eq_p_(linkage,string_dash__gt_symbol("next"))) {return o18;
} else {return linkage;
}})()
;
var o20 = compile(if_dash_predicate(exp),string_dash__gt_symbol("val"),string_dash__gt_symbol("next"));
var o21 = compile(if_dash_consequent(exp),target,o19);
var o22 = compile(if_dash_alternative(exp),target,linkage);
return o15(o16,o17,o18,o19,o20,o21,o22);
}))();
});
...
return ((function() {var o23 = (function(proc_dash_entry,after_dash_lambda,lambda_dash_linkage){
...
var o24 = make_dash_label(string_dash__gt_symbol("entry"));
var o25 = make_dash_label(string_dash__gt_symbol("after_dash_lambda"));
var o26 = (function() {if(eq_p_(linkage,string_dash__gt_symbol("next"))) {return o25;
} else {return linkage;
}})()
;
return o23(o24,o25,o26);
}))();
});
var compile_dash_lambda_dash_body = (function(exp,proc_dash_entry){
return ((function() {var o27 = (function(formals){
...
var o28 = lambda_dash_parameters(exp);
return o27(o28);
}))();
});
var compile_dash_application = (function(exp,target,linkage){
return ((function() {var o29 = (function(proc_dash_code,operand_dash_codes){
...
var o30 = compile(operator(exp),string_dash__gt_symbol("proc"),string_dash__gt_symbol("next"));
var o31 = map((function(operand){
...
return ((function() {var o32 = (function(operand_dash_codes){
...
} else {return ((function() {var o34 = (function(code_dash_to_dash_get_dash_last_dash_arg){
...
var o35 = append_dash_instruction_dash_sequences(car(operand_dash_codes),make_dash_instruction_dash_sequence(list(string_dash__gt_symbol("val")),list(string_dash__gt_symbol("arg1")),list(list(string_dash__gt_symbol("assign"),string_dash__gt_symbol("arg1"),list(string_dash__gt_symbol("op"),string_dash__gt_symbol("list")),list(string_dash__gt_symbol("reg"),string_dash__gt_symbol("val"))))));
return o34(o35);
}))();
}})()
;
});
var o33 = reverse(operand_dash_codes);
return o32(o33);
}))();
});
var code_dash_to_dash_get_dash_rest_dash_args = (function(operand_dash_codes){
return ((function() {var o36 = (function(code_dash_for_dash_next_dash_arg){
...
var o37 = preserving(list(string_dash__gt_symbol("arg1")),car(operand_dash_codes),make_dash_instruction_dash_sequence(list(string_dash__gt_symbol("val"),string_dash__gt_symbol("arg1")),list(string_dash__gt_symbol("arg1")),list(list(string_dash__gt_symbol("assign"),string_dash__gt_symbol("arg1"),list(string_dash__gt_symbol("op"),string_dash__gt_symbol("cons")),list(string_dash__gt_symbol("reg"),string_dash__gt_symbol("val")),list(string_dash__gt_symbol("reg"),string_dash__gt_symbol("arg1"))))));
return o36(o37);
}))();
});
var compile_dash_procedure_dash_call = (function(target,linkage){
return ((function() {var o38 = (function(primitive_dash_branch,compiled_dash_branch,after_dash_call,compiled_dash_linkage){
...
var o39 = make_dash_label(string_dash__gt_symbol("primitive_dash_branch"));
var o40 = make_dash_label(string_dash__gt_symbol("compiled_dash_branch"));
var o41 = make_dash_label(string_dash__gt_symbol("after_dash_call"));
var o42 = (function() {if(eq_p_(linkage,string_dash__gt_symbol("next"))) {return o41;
} else {return linkage;
}})()
;
return o38(o39,o40,o41,o42);
}))();
});
...
return (function() {if(self_dash_evaluating_p_(exp)) {return ((function() {return compile_dash_self_dash_evaluating(exp,target,linkage);
}))();
