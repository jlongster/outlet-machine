...
var compiler = require("./compiler");var machine = require("./machine");var run = (function(src){
return ((function() {var o1 = (function(statements,m){
m.start();
return ((function() {var o4 = (function(res){
return (function() {if(res) {return pp(res);
} else {return false;
}})()
;
});
var o5 = machine.result();
return o4(o5);
}))();
});
...
run(list(string_dash__gt_symbol("begin"),list(string_dash__gt_symbol("define"),list(string_dash__gt_symbol("factorial"),string_dash__gt_symbol("n")),list(string_dash__gt_symbol("define"),list(string_dash__gt_symbol("iter"),string_dash__gt_symbol("product"),string_dash__gt_symbol("counter")),list(string_dash__gt_symbol("if"),list(string_dash__gt_symbol("_gt_"),string_dash__gt_symbol("counter"),string_dash__gt_symbol("n")),string_dash__gt_symbol("product"),list(string_dash__gt_symbol("iter"),list(string_dash__gt_symbol("*"),string_dash__gt_symbol("counter"),string_dash__gt_symbol("product")),list(string_dash__gt_symbol("+"),string_dash__gt_symbol("counter"),1)))),list(string_dash__gt_symbol("iter"),1,1)),list(string_dash__gt_symbol("pp"),list(string_dash__gt_symbol("factorial"),100))));
